...
I'm a hobbyist programmer who codes for the love of the game. I program anything that peeks my interest, mostly game development and reverse engineering. I have no interest in network/web programming.

### Language of choice?
Anything but C++ or Javascript 🤢. I like learning new languages and tools, I can easily move between them depending on my goal.
...
My second active project is the [SSX-Library](https://github.com/GlitcherOG/SSX-Library). A tool for facilitating modding for [SSX games](https://en.wikipedia.org/wiki/SSX). I'm not the lead dev but I contribute and aid on its development almost weekly.
