...
My second active project is the [SSX-Library](https://github.com/GlitcherOG/SSX-Library). A tool for facilitating modding for [SSX games](https://en.wikipedia.org/wiki/SSX). I'm not the lead dev but I contribute and aid on its development almost weekly. (Pls merge my pull requests faster!!)

### Why is [Chip8 decompiler](https://github.com/Erickson400/chip8-decompiler) my most starred repo?
I have no idea. Maybe because it's written in python. Or because more people are getting into automated decompilation and want to start small. I might port the project to a low level language and make it even better, documenting the process for teaching potential, who knows.

This is a tough project because of the [halting problem](https://en.wikipedia.org/wiki/Halting_problem), deep pattern analysis, indirect jumps at runtime, and the fact that Chip8 has self modifying code. This makes it almost impossible to recreate it's dynamic assembly code into a high level language with static code. But something tells me it might be possible.

### How can you contact me?
You can email me at claudespeed400@gmail.com. Or join the SSX Modding [discord server](https://discord.gg/8rFjDgnc)
